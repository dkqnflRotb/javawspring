...
insert into member2 values (default,'admin','1234','관리맨','관리자',default,default,'010-3423-2704','청주시 사직대로 168','rlaehdaud42@naver.com','http://naver.com','프리랜서','게임/영화감상',default,'관리자입니다.',default,default,default,0,default,default,default,default);
