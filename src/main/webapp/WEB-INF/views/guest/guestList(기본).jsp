		...
		<div class="text-center">
			<ul class="pagination justify-content-center">
				...
				<c:if test="${curBlock > 0}">
					<li class="page-item"><a class="page-link text-secondary" href="${ctp}/guList.gu?pag=${(curBlock-1)*blockSize + 3}">이전페이지</a></li>
				</c:if>
				...
				<c:if test="${curBlock < lastBlock}">
					<li class="page-item"><a class="page-link text-secondary" href="${ctp}/guList.gu?pag=${(curBlock+1)*blockSize + 1}">다음페이지</a></li>
				</c:if>
				<c:if test="${pag < totPage}">
