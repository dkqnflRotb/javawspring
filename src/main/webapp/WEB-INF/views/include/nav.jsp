...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.145:9090/javawspring" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <c:if test="${!empty sLevel}">
    	<a href="${ctp}/member/memberLogout" class="w3-padding-large w3-button">Logout</a>
    </c:if>
