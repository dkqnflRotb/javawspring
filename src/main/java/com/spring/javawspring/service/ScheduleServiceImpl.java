...
public class ScheduleServiceImpl implements ScheduleService {
	...
	public void getSchedule() {
		// model객체를 사용하게되면 불필요한 메소드가 많이 따라오기에 여기서는 request객체를 사용했다.
			  ...
			  // sql에 등록된 dataformat의 비교형식을 맞춰주기 위한 날자형식변환작업
			  // 해당 년월의 형식 변환? 2023-1 ====>  2030-01
			  ...
			  List<ScheduleVO> vos = schedulDAO.getScheduleList(mid, ym);
	...
	public List<ScheduleVO> getScheduleMenu(String mid, String ymd) {
		...
		return schedulDAO.getScheduleMenu(mid, ymd);
	}

	@Override
	public void setScheduleInputOk(ScheduleVO vo) {
		schedulDAO.setScheduleInputOk(vo);
		
	}

	@Override
	public void setScheduleUpdateOk(ScheduleVO vo) {
		schedulDAO.setScheduleUpdateOk(vo);	
	}

	@Override
	public void setScheduleDeleteOk(ScheduleVO vo) {
		schedulDAO.setScheduleDeleteOk(vo);
